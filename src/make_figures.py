...
Usage:
    python src/make_figures.py --results_root outputs/v2 \
        --attention_dir outputs/v2/analysis/attention_v2 \
        --out_dir outputs/v2/figures
"""
...
def main():
    ...
    ap.add_argument('--results_root', default='outputs/v2')
    ap.add_argument('--attention_dir', default='outputs/v2/analysis/attention_v2')
    ap.add_argument('--out_dir', default='outputs/v2/figures')
    args = ap.parse_args()
