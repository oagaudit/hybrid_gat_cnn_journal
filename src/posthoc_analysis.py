"""
src/posthoc_analysis.py  --  NEW FILE

Runs on the test_probabilities.csv files that train_stage2_v2.py writes, so none
...
Usage:
    python src/posthoc_analysis.py --out_dir outputs/analysis/posthoc \
        --model M4=outputs/models_stage2_v2/in_sample/hybrid/test_probabilities.csv \
        --model M3=outputs/models_stage2_v2/in_sample/gatv2/test_probabilities.csv \
        --model RF=outputs/models_stage2_v2/in_sample/rf/test_probabilities.csv \
