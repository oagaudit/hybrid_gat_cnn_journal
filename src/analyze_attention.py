"""
src/analyze_attention_v2.py  --  REPLACES analyze_attention.py
...
Usage:
    python src/analyze_attention_v2.py \
        --pair_set_dir outputs/pair_sets/insample \
        --model_ckpt outputs/v2/in_sample/M4_contextual_norm/model_run1.pt \
        --bridge_kind contextual --norm_scope all \
        --out_dir outputs/v2/analysis/attention_v2
"""
