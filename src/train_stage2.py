...
python src/train_stage2.py --model_type hybrid --pair_set_dir outputs/pair_sets/insample \
    --out_dir outputs/results/in_sample/hybrid --num_runs 5

# Pooling ablation
python src/train_stage2.py --model_type hybrid --bridge_kind mean  ... --out_dir .../hybrid_meanpool
python src/train_stage2.py --model_type hybrid --bridge_kind uncond ... --out_dir .../hybrid_uncond

# Graph-necessity control
python src/train_stage2.py --model_type mlp ... --out_dir .../mlp

# LOCO few-shot with full normalisation
python src/train_stage2.py --model_type hybrid --pair_set_dir outputs/pair_sets/fold_japan \
    --test_country japan --fine_tune_ratio 0.15 --norm_scope all \
    --out_dir outputs/results/loco/japan_c3
"""
